/**
 * ISO 3166-1 数字码 → alpha-2。
 *
 * world-atlas 的国家 id 是数字码（"242" = 斐济），而我们全站（国旗文件名、
 * GeoIP 返回值、数据库里存的 country）用的都是 alpha-2。
 *
 * 这张表由 `scripts/gen-globe.mjs` 校验：产出的每个 alpha-2 都必须在
 * `flag-icons` 的国家列表里找得到，打错一个字母就会构建失败。
 */
export const ISO_NUMERIC_TO_ALPHA2 = Object.fromEntries(
  `010=AQ 004=AF 008=AL 012=DZ 016=AS 020=AD 024=AO 028=AG 031=AZ 032=AR 036=AU 040=AT 044=BS
